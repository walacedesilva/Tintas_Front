    ...
    <div class="max-w-xl">
      <div class="bg-white rounded-xl border border-gray-200 p-6">
        ...
        <form [formGroup]="form" (ngSubmit)="submit()" class="space-y-4">
          ...
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">Loja (ID) *</label>
            <input type="text" formControlName="lojaId" placeholder="UUID da loja"
